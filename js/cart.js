        ...
        cart.forEach(cartItem => {
            ...
            const itemHtml = `
                <div class="d-flex align-items-start mb-4 px-2">
                    <img src="${encodedPath}" class="img-fluid" style="width: 100px; height: 100px; object-fit: cover; border-radius: 4px;" alt="${product.name}">
                    <div class="ms-3 flex-grow-1">
                        ...
                        <button class="btn btn-dark btn-sm rounded-0 w-100 py-1" 
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="cartOffcanvas" aria-labelledby="cartOffcanvasLabel" style="width: 400px;">
            <div class="offcanvas-header border-bottom">
                <h5 class="offcanvas-title" id="cartOffcanvasLabel" style="font-family: 'Playfair Display', serif;">
                    Shopping Cart 
                    <span class="badge bg-black rounded-circle cart-count" style="font-size: 0.8rem; vertical-align: top;">0</span>
                </h5>
            ...
            <div class="offcanvas-body d-flex flex-column">
                ...
                <div class="mt-auto pt-4 border-top">
                    ...
                    <div class="d-grid gap-2">
                         <button class="btn btn-outline-dark text-uppercase rounded-0 py-2">View Cart</button>
                         <button class="btn btn-dark text-uppercase rounded-0 py-2">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
